    ...
    <div class="container mx-auto flex px-5 py-10 sm:py-24 items-center justify-center flex-col">
        <div class="text-center lg:w-2/3 w-full">
            ...
            <p class="mb-8 leading-relaxed">
                Empowering young minds with engaging and educational content to inspire a lifelong love for reading.
            </p>
        </div>
    </div>
</section>
...
<section class="mb-20">
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 p-5">
        <div class="shadow-lg p-3 sm:p-10 rounded-lg">
            <img src="https://sterncenter.org/wp-content/uploads/2015/05/Reading-with-Toddler-1024x683.jpg" alt="About page preview">
        </div>
        <div class="shadow-lg p-3 sm:p-10 rounded-lg row-span-2">
            <img src="https://www.newhorizonacademy.net/wp-content/uploads/2023/08/mother-reading-to-toddler.jpg" alt="Pricing page preview">
        </div>
    </div>
</section>
