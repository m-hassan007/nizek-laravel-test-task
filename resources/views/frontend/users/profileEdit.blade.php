            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6">
                            <label class="block-inline text-sm font-medium text-gray-700" for="p_type">Payment through</label>
                            ...
                            <input
                                ...
                                type="text"
                                id="p_type"
                                value="{{ $user->p_type ?? 'N/A' }}"
                                disabled>
                        </div>

                        <div class="col-span-6">
                            <label class="block-inline text-sm font-medium text-gray-700" for="stripe_id">Stripe ID</label>
                            <span class="text-danger text-red-600">*</span>
                            <input
                                class="mt-1 border-gray-300 w-full py-2 px-4 bg-gray-200 text-gray-700 placeholder-gray-300 rounded border shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                                type="text"
                                id="stripe_id"
                                value="{{ $user->stripe_id ?? 'N/A' }}"
                                disabled>
                        </div>

                        <div class="col-span-6">
                            <label class="block-inline text-sm font-medium text-gray-700" for="trial_ends_at">Trial Ends At</label>
                            <span class="text-danger text-red-600">*</span>
                            <input
                                class="mt-1 border-gray-300 w-full py-2 px-4 bg-gray-200 text-gray-700 placeholder-gray-300 rounded border shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                                type="text"
                                id="trial_ends_at"
                                value="{{ \Carbon\Carbon::parse($user->trial_ends_at)->format('Y-m-d H:i:s') ?? 'N/A' }}"
                                disabled>
                        </div>
