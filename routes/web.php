...
Route::group(['namespace' => 'App\Http\Controllers\Frontend', 'as' => 'frontend.'], function () {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        */
        ...
        // Pricing page
        Route::get("$module_name", ['as' => "subscription.pricing", 'uses' => "$controller_name@pricing"]);

        // Submit subscription form and redirect to Stripe checkout
        Route::post("$module_name/submit", ['as' => "subscription.submit", 'uses' => "$controller_name@submit"]);

        // Handle successful subscription
        Route::get("$module_name/success", ['as' => "subscription.success", 'uses' => "$controller_name@success"]);

        // Handle canceled subscription
        Route::get("$module_name/cancel", ['as' => "subscription.cancel", 'uses' => "$controller_name@cancel"]);
    });
});
